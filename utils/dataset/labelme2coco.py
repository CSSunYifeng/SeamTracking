...
class labelme2coco(object):
    def __init__(self, labelme_json=[], args = None):#save_json_path="./coco.json"):
        """
        :param labelme_json: the list of all labelme json file paths
        :param save_json_path: the path to save new json
        """
        self.root = args.labelme_images
    ...
    def image(self, data, num):
        image = {}
        # print(data)
        img = cv2.imread(os.path.join(self.root,data["imagePath"]))# utils.img_b64_to_arr(data["imageData"])
    ...
    def getbbox(self, points):
        _x,_y = (points[0][0]-10,points[0][1]-10)
        polygons = [[_x,_y],[_x+20,_y+20]]
...
if __name__ == "__main__":
    ...
    labelme2coco(labelme_json, args)